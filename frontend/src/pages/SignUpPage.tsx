...
const SignUpPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("Sign up submitted", { name, email, password, rememberMe });
      ...
      <div className="login-overlay">
        <div className="login-modal">
          ...
          <div className="login-header">
            ...
            <p className="login-subtitle">Sign up to start backing up your files</p>
          </div>
          ...
          <form className="login-form" onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              <div className="input-icon">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M10 10C12.7614 10 15 7.76142 15 5C15 2.23858 12.7614 0 10 0C7.23858 0 5 2.23858 5 5C5 7.76142 7.23858 10 10 10Z" stroke="#64748b" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M20 20C20 16.134 15.5228 13 10 13C4.47715 13 0 16.134 0 20" stroke="#64748b" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
              <input
                type="text"
          ...
          <div className="login-signup">
            <p>Already have an account? <a href="#signin" onClick={(e) => { e.preventDefault(); window.location.hash = "signin"; }}>Sign in</a></p>
          </div>
