...
const DashboardPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans relative overflow-hidden transition-colors duration-300">
      ...
      {/* Navbar */}
      <nav className="bg-white/70 backdrop-blur-xl border-b border-gray-200/50 sticky top-0 z-50 transition-all shadow-sm">
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-3 bg-slate-50 px-4 py-2 rounded-2xl border border-slate-100">
              ...
              <div className="text-left hidden sm:block">
                ...
                <p className="text-[10px] font-black text-indigo-600 mt-1 uppercase tracking-widest">{user?.role} Access</p>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto w-full p-6 md:p-10 space-y-10 relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <div className="flex items-center gap-2 bg-white/80 backdrop-blur-sm p-1.5 rounded-2xl border border-gray-200/60 shadow-sm">
             <div className="px-4 py-2 bg-gray-50/80 rounded-xl flex items-center gap-2">
                ...
                <span className="text-[10px] font-black text-gray-500 tracking-[0.2em]">SYNC: {stats?.last_sync.split(' ')[1]}</span>
             </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white/80 backdrop-blur-md p-8 rounded-[2rem] border border-gray-200/60 shadow-sm flex items-center justify-between group hover:border-indigo-200 hover:shadow-xl transition-all duration-300">
            <div className="space-y-2">
              <p className="text-[10px] font-black text-gray-400 tracking-[0.2em]">Pending Projects</p>
          ...
          <div className="bg-white/80 backdrop-blur-md p-8 rounded-[2rem] border border-gray-200/60 shadow-sm flex items-center justify-between group hover:border-emerald-200 hover:shadow-xl transition-all duration-300">
            <div className="space-y-2">
              <p className="text-[10px] font-black text-gray-400 tracking-[0.2em]">Total Archived</p>
          ...
          <div className="bg-white/80 backdrop-blur-md p-8 rounded-[2rem] border border-gray-200/60 shadow-sm flex items-center justify-between group hover:border-indigo-200 hover:shadow-xl transition-all duration-300">
            <div className="space-y-2">
              <p className="text-[10px] font-black text-gray-400 tracking-[0.2em]">Auth Protocol</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white/80 backdrop-blur-md p-10 rounded-[3rem] border border-gray-200/60 shadow-sm hover:shadow-2xl hover:-translate-y-1 transition-all duration-500 group relative overflow-hidden flex flex-col justify-between h-full">
            ...
            <div>
              ...
              <p className="text-gray-500 font-medium mb-10 leading-relaxed text-lg max-w-md">
                Execute archival sequences, validate links, and synchronize project status with Google Sheets.
              </p>
            </div>
            <button 
          ...
          <div className="bg-white/80 backdrop-blur-md p-10 rounded-[3rem] border border-gray-200/60 shadow-sm hover:shadow-2xl hover:-translate-y-1 transition-all duration-500 group relative overflow-hidden flex flex-col justify-between h-full">
            ...
            <div>
              <div className="w-20 h-20 bg-gradient-to-br from-teal-500 to-emerald-600 rounded-[1.5rem] flex items-center justify-center text-white mb-8 group-hover:scale-110 transition-transform duration-500 shadow-xl shadow-teal-200/50">
            ...
            <button 
              ...
              className="w-full flex items-center justify-center gap-3 py-5 bg-white border-2 border-teal-600 text-teal-600 hover:bg-teal-50 rounded-2xl font-black text-sm tracking-[0.2em] transition-all active:scale-[0.98]"
            >
        ...
        {/* Analytics Card - NEW */}
        <div className="bg-white/80 backdrop-blur-md p-10 rounded-[3rem] border border-gray-200/60 shadow-sm hover:shadow-2xl hover:-translate-y-1 transition-all duration-500 group relative overflow-hidden flex flex-col justify-between md:flex-row items-center gap-8 z-20">
          <div className="absolute -right-10 -top-10 opacity-[0.03] group-hover:opacity-[0.05] transition-opacity pointer-events-none">
              <Zap className="w-64 h-64 rotate-6" />
          </div>
          <div className="flex flex-col md:flex-row items-center gap-8 flex-1 pointer-events-none">
